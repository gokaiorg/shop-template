...
export default async function AdminDashboardPage({
    ...
    const [session, dict, productsSnap, categoriesSnap, recentOrders, pendingOrdersCount] = await Promise.all([
        auth(),
        ...
        <div className="space-y-8">
            ...
            {isCartEnabled ? (
                ...
                <div className="grid gap-6 md:grid-cols-2">
                    ...
                    <Card>
                        <CardHeader>
                            <CardTitle>Catalog & Content</CardTitle>
                        ...
                        <CardContent className="space-y-3">
                            ...
                            <Link href={`/${lang}/admin/pages`} className="flex items-center p-3 border rounded-lg hover:bg-muted/50 transition-colors">
                                ...
                                <div className="flex-1">
                                    ...
                                    <p className="text-xs text-muted-foreground">Edit custom content pages (About, Terms, etc.)</p>
                                </div>
                                <ArrowRight className="h-4 w-4 text-muted-foreground" />
                            </Link>
                            ...
                            <Link href={`/${lang}/admin/settings`} className="flex items-center p-3 border rounded-lg hover:bg-muted/50 transition-colors">
                                ...
                                <div className="flex-1">
                                    ...
                                    <p className="text-xs text-muted-foreground">Customize brand name, logo, and hero banners</p>
                                </div>
                                <ArrowRight className="h-4 w-4 text-muted-foreground" />
                            </Link>
                        </CardContent>
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>Manage your administrator profile and credentials.</CardDescription>
                        </CardHeader>
                        <CardContent>
                            <ProfileForm 
                                user={{ 
